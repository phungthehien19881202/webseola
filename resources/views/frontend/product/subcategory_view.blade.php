    ...
    <div class="auto-container">
        <div class="content__box p_relative">
            <ul class="bread__crumb">
                ...
                <li> <span> -</span> <a href="{{ url($categories->category_slug_vn).'/c' }}">{{ $categories->category_name_vn }} </a></li>
                <li> <span> -</span> {{ $categories->category_name_vn }} </li>
            </ul>
            <h1 class="title">{{ $subcategories->subcategory_name }}</h1>
        </div>
    </div>
</section>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="service__center">
                {!! $subcategories->subcategory_content !!}
