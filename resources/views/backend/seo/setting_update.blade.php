...
<div class="container-full">
	...
	<div class="form-group">
			...
			<div class="controls">
	 <input type="file" name="logo" class="form-control" onChange="mainThamUrl(this)">
    
	 <img src="{{ asset($setting->logo) }}" id="mainThmb">
	 		 </div>
		</div>
...
<div class="form-group">
			...
			<div class="controls">
	<textarea name="google_analytic" class="form-control">{{ $setting->google_analytic }}</textarea>     
	 		 </div>
		</div>
</div>
<div class="col-md-12">
<div class="form-group">
			<h5>Pixel facebook <span class="text-danger">*</span></h5>
			<div class="controls">
	<textarea name="pixel_facebook" class="form-control">{{ $setting->pixel_facebook }}</textarea>     
	 		 </div>
		</div>
</div>
