...
@section('admin')
  ...
  <!-- Content Wrapper. Contains page content -->
			...
			<div class="col-8">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Danh sách chuyên mục <span class="badge badge-pill badge-danger"> {{ count($blogcategory) }} </span></h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
	 ...
	 <tr>
		<td>{{ $item->blog_category_name }}( {{
										$posts->where('category_id', $item->id)->count();
									}} Bài viết )</td>
...
<!--   ------------ Add Blog Category Page -------- -->
 ...
 <form method="post" action="{{ route('blogcategory.store') }}" >
	 ...
	 <div class="form-group">
		<h5>Tên chuyên mục  <span class="text-danger">*</span></h5>
		<div class="controls">
